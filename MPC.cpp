...
class FG_eval 
{
	...
	// `vars` is a vector of state & actuator values
	//*********************************************************
	void operator()(ADvector& fg, const ADvector& vars) 
	{
		...
		{
			fg[0] += 45 * CppAD::pow(vars[cte_start + t], 2);
...
//			std::cout << fg[1+x_start+t] << "\t";

			fg[1 + y_start + t] = y1 - (y0 + v0 * CppAD::sin(psi0) * dt);
//			std::cout << fg[1+y_start+t] << "\t";

			fg[1 + psi_start + t] = psi1 - (psi0 + v0 * delta0 / Lf * dt);
//			std::cout << fg[1+psi_start+t] << "\t";
			
			fg[1 + v_start + t] = v1 - (v0 + a0 * dt);
//			std::cout << fg[1+v_start+t] << "\t";
	
			fg[1 + cte_start + t] = cte1 - ((f0 - y0) + (v0 * CppAD::sin(epsi0) * dt));
//			std::cout << fg[1+cte_start+t] << "\t";
	
			fg[1 + epsi_start + t] =  epsi1 - ((psi0 - psides0) + 
														v0 * delta0 / Lf * dt);
//			std::cout << fg[1+epsi_start+t] << "\n";
...
//	std::cout << "In MPC::Solve(state, coeffs) \n";
	...
	// TODO: Set the number of model variables (includes both states and inputs).
  	...
  	//
   	size_t n_vars = N * 6 + (N-1) * 2;	// 60 + 18 = 78
...
//	std::cout << "prev_d = " << prev_d << "\t" << "prev_a = " << prev_a << "\n";
